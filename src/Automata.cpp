...
void Automata::on() {
    ...
    case OFF:
        ...
        break;
    default:
        std::cout << "AUTOMATA STATE CANT CHANGE FROM STATE: "
                  << get_state() << std::endl;
        break;
    }
}
...
void Automata::coin(double shekelz) {
    ...
    case ACCEPT:
        ...
        cash += shekelz;
        std::cout << "AUTOMATA GAINED " << shekelz
                  << " MONEY AMOUNT. AUTOMATA TOTAL CASH: " << cash
                  << std::endl;
        break;
    default:
        std::cout << "AUTOMATA STATE CANT CHANGE FROM STATE: "
...
bool Automata::check() {
    ...
    case CHECK:
        ...
        return true;
    default:
        std::cout << "AUTOMATA CANT CHECK MENU IN STATE: "
                  << get_state() << std::endl;
        return false;
    }
}
